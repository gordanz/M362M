...
happens with probability $2^{-T}$. On the other hand, this maximal value is at last $0$, since
...
attacking $\PP[ M_n=l]$ directly. The symmetry assumption ensures that
...
To see why that is true, start by taking a trajectory $\omega\in A_l^{>}$ and denoting by
...
in the following way; follow $\omega$ until time $\tau_l(\omega)$. After that, $\bar{\omega}$ is the reflection of $\omega$ around the level $l$. In other words, the increments of $\omega$ and $\bar{\omega}$ are exactly the same up to time $\tau(\omega)$, and exactly the opposite afterwards. It will all be clear once you see the picture below - the orange trajectory is $\omega$ and the green trajectory is its 
...
$$\begin{aligned}
     ...
     X_n=n] = \sum_{k=l+1}^n \PP[X_n = k],\end{aligned}.$$ 
...
<p class="solution">The first question is exactly the opposite of the question in our previous example, so the answer is
  ...
  value $0$ after exactly $2N$ steps. Even though no single other value is more 
  ...
  > We have $N! \sim \sqrt{2 \pi N} \left( \tf{N}{e} \right)^N$ where
  ...
  to conclude that 
  $$ \lim_{N\to\infty} \binom{2N}{N} 2^{-2n} = \lim_{N\to\infty} \frac{1}{\sqrt{N \pi}} = 0 $$</p>

What we just computed is more than just an exercise. It proves an important fact:
...
-->
<!-- <div class="problem"> -->
<!-- ```{r child="problems/01_Random_Walks/never-reach-5_prb.Rmd"} -->
<!-- ``` -->
<!-- </div> -->
<!-- <div class="solution"> -->
<!-- ```{r child="problems/01_Random_Walks/never-reach-5_sol.Rmd"} -->
<!-- ``` -->
<!-- </div> -->
...
-->
<!-- <div class="problem"> -->
<!-- ```{r child="problems/01_Random_Walks/dollar-if-match_prb.Rmd"} -->
<!-- ``` -->
<!-- </div> -->
<!-- <div class="solution"> -->
<!-- ```{r child="problems/01_Random_Walks/dollar-if-match_sol.Rmd"} -->
<!-- ``` -->
<!-- </div> -->
...
-->
<!-- <div class="problem"> -->
<!-- ```{r child="problems/01_Random_Walks/H-exceed-T-by-3_prb.Rmd"} -->
<!-- ``` -->
<!-- </div> -->
<!-- <div class="solution"> -->
<!-- ```{r child="problems/01_Random_Walks/H-exceed-T-by-3_sol.Rmd"} -->
<!-- ``` -->
<!-- </div> -->
