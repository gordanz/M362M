...
You only have to do it once, though. Skip this step if you have LaTeX already installed on your system^[it may interfere with your existing installation].  Start with 
```markdown
