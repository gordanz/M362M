...
```{r child = 'problems/00_R/R-calc.prb'}
```
```{r child = 'problems/00_R/R-calc.sol'}
```

```{r child = 'problems/00_R/R-vars.prb'}
```
```{r child = 'problems/00_R/R-vars.sol'}
```

```{r child = 'problems/00_R/R-vect.prb'}
```
```{r child = 'problems/00_R/R-vect.sol'}
```

```{r child = 'problems/00_R/R-func.prb'}
```
```{r child = 'problems/00_R/R-func.sol'}
```
